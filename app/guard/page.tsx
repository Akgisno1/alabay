  ...
  return (
    <div className="h-screen w-screen overflow-hidden relative">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/Games/guardpage.png')",
      ...
      >
        <div className="w-full h-full flex flex-col items-start text-white p-10 max-sm:p-2">
          <div className="flex flex-col ">
            ...
            <div className=" mt-4 w-fit text-sm p-2 font-bold tracking-wide text-zinc-800 flex flex-row items-center justify-center gap-6 rounded-full transition-colors shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] duration-300 bg-violet-400 pr-10">
      ...
      >
        <div className="w-full h-full flex flex-col items-start text-white p-10 max-sm:p-2 max-sm:pr-6">
          <div className="flex flex-col text-md leading-tight">
            ...
            <div className="pt-6 text-violet-400 text-2xl tracking-widest font-mont ">
              FEATURES
            </div>
            <p className="font-mont pt-6  tracking-widest">
              Explore a variety of landscapes, including{" "}
              <span className="text-violet-400">mountains</span>,{" "}
              <span className="text-violet-400">forests</span>,{" "}
              <span className="text-violet-400">deserts</span> and{" "}
            ...
            <p className="font-mont pt-6  tracking-widest">
              Challenge Modes:  <br />  -{" "}
              <span className="text-violet-400">Time Trials</span>: Compete in
