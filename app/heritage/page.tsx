  ...
  return (
    <div className="fixed right-8 top-1/2 transform -translate-y-1/2 flex flex-col justify-between items-center z-10 h-[50vh]">
      ...
      <button
        ...
        className={`flex justify-center items-center mb-4 w-10 h-14 rounded-md bg-opacity-50 bg-gray-500 transition-all duration-300 hover:bg-green-500 ${
      ...
      <button
        ...
        className={`flex justify-center items-center mt-4 w-10 h-14 rounded-md bg-opacity-50 bg-gray-500 transition-all duration-300 hover:bg-green-500 ${
      ...
      >
        <div className="w-full h-full flex flex-col items-start text-white p-10">
          <div className="flex flex-col ">
            ...
            <div className="font-bebas text-[7vh] tracking-widest leading-tight text-emerald-400">
              THE LOST ADVENTURE
            </div>
          ...
          <div className="flex flex-col w-full items-start gap-2 mt-20">
            ...
            <div className="flex flex-row justify-start gap-4 items-center h-[20vh] mt-10">
              <img
                src="/Games/Heritage/overview.png"
                className="h-[29vh] rounded-xl border-2 border-white"
              />
              <img
