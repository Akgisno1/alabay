...
const SectionFive = () => {
  return (
    <div className="relative w-full mt-20 px-16 max-sm:p-2">
      ...
      <div className="flex flex-col w-full font-mont gap-3 font-black text-white">
        ...
        <div className="flex max-sm:flex-col flex-row relative z-20 gap-3">
          {/* Row 1 */}
          <div className="flex flex-row w-full gap-3">
            ...
            {/* Card 2 */}
            <div
              className="relative flex flex-col items-center bg-sky-500 flex-grow p-4 max-sm:rounded-r-3xl overflow-hidden"
              style={{
          ...
          <div className="flex flex-row w-full gap-3">
            {/* Card 3 */}
            <div
              className="relative flex flex-col items-center bg-fuchsia-500 max-sm:rounded-l-3xl flex-grow p-4 overflow-hidden"
              style={{
            ...
            >
              ...
              <div className="text-[1.5vw] text-center">Features</div>
